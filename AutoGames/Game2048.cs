...
namespace AutoGames
{
    public class Game2048 : Game
    {
        ...
        protected override Network GenerateNetwork() => new Network(new int[] { BoardSize + 2, 20, 11, 1 }, Network.ActivationFunctions.TanH, Network.MutateFunctions.GenerateReplacement(1));
